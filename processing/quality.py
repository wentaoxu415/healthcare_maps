...
with open(complication_file, 'rU') as complication_fh:
	...
	for row in complication_csv:
		...
		if "Not Available" not in row[12]:
			if row[9] == "COMP_HIP_KNEE":
				scores[row[1]] += round((float(row[12]) - means[0])/std[0], 2)
			elif row[9] == "MORT_30_AMI":
				scores[row[1]] += round((float(row[12]) - means[1])/std[1], 2)
			elif row[9] == "MORT_30_COPD":
				scores[row[1]] += round((float(row[12]) - means[2])/std[2], 2)
			elif row[9] == "MORT_30_HF":
				scores[row[1]] += round((float(row[12]) - means[3])/std[3], 2)
			elif row[9] == "MORT_30_PN":
				scores[row[1]] += round((float(row[12]) - means[4])/std[4], 2)
			elif row[9] == "MORT_30_STK":
				scores[row[1]] += round((float(row[12]) - means[5])/std[5], 2)
			elif row[9] == "PSI_12_POSTOP_PULMEMB_DVT":
				scores[row[1]] += round((float(row[12]) - means[6])/std[6], 2)
			elif row[9] == "PSI_14_POSTOP_DEHIS":
				scores[row[1]] += round((float(row[12]) - means[7])/std[7], 2)
			elif row[9] == "PSI_15_ACC_LAC":
				scores[row[1]] += round((float(row[12]) - means[8])/std[8], 2)
			elif row[9] == "PSI_4_SURG_COMP":
				scores[row[1]] += round((float(row[12]) - means[9])/std[9], 2)
			elif row[9] == "PSI_6_IAT_PTX":
				scores[row[1]] += round((float(row[12]) - means[10])/std[10], 2)
			elif row[9] == "PSI_90_SAFETY":
				scores[row[1]] += round((float(row[12]) - means[11])/std[11], 2)
			elif row[9] == "READM_30_AMI":
				scores[row[1]] += round((float(row[12]) - means[12])/std[12], 2)
			elif row[9] == "READM_30_COPD":
				scores[row[1]] += round((float(row[12]) - means[13])/std[13], 2)
			elif row[9] == "READM_30_HF":
				scores[row[1]] += round((float(row[12]) - means[14])/std[14], 2)
			elif row[9] == "READM_30_HIP_KNEE":
				scores[row[1]] += round((float(row[12]) - means[15])/std[15], 2)
			elif row[9] == "READM_30_HOSP_WIDE":
				scores[row[1]] += round((float(row[12]) - means[16])/std[16], 2)
			elif row[9] == "READM_30_PN":
				scores[row[1]] += round((float(row[12]) - means[17])/std[17], 2)
			elif row[9] == "READM_30_STK":
				scores[row[1]] += round((float(row[12]) - means[18])/std[18], 2)
