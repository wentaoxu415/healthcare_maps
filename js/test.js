SpendingVis2 = function(_parentElement, _spendingData, _eventHandler){
...
SpendingVis2.prototype.initVis = function(){
    var that = this; 
...
SpendingVis2.prototype.onSelectionChange = function(d){
	var that = this;
	console.log(d);	
}
